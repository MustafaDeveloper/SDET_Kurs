...
public class BaseStaticDriver {
     ...
     static {
         ...
         driver.manage().timeouts().pageLoadTimeout(30,TimeUnit.SECONDS); // sadece sayfa yüklenirken en başta
         driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS); // bütün elemanlar için geçerli
     }
}
